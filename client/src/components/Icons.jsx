/**
 * SVG icons - modern stroke style, 24x24, currentColor
 */
const size = 24;
const stroke = 2;
...
export function IconPlay(props) {
  const { className, size: s, ...rest } = props;
  return (
    <svg width={s ?? size} height={s ?? size} viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className={className} {...rest}>
...
export function IconHeart(props) {
  const { className, size: s, filled, ...rest } = props;
  return (
    <svg width={s ?? size} height={s ?? size} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className={className} {...rest}>
